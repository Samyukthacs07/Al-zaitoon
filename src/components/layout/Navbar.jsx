...
export default function Navbar() {
    ...
    const isHeroTransparent = !scrolled && (pathname === '/' || pathname === '/home');
                ...
                <div className={clsx(
                    ...
                    {navLinks.map((link) => (
                        <Link
                            ...
                            href={link.path}
                            className={clsx(
                                'text-[15px] font-sans tracking-wide transition-all duration-300 relative group inline-block',
                                !isHeroTransparent
                                    ? clsx( // Dark text for white scrolled background
                                        pathname === link.path
                                            ? 'text-primary font-medium'
                                            : 'text-[var(--color-app-text)] font-medium hover:text-primary'
                                    )
